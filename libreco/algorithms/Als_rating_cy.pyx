...
cdef inline void gemv(char *trans, int *m, int *n, floating *alpha, floating *a, int *lda, floating *x,
                      int *incx, floating *beta, floating *y, int *incy) nogil:
    if floating is double:
        cython_blas.dgemv(trans, m, n, alpha, a, lda, x, incx, beta, y, incy)
    else:
        cython_blas.sgemv(trans, m, n, alpha, a, lda, x, incx, beta, y, incy)
...
cdef inline void ger(int * m, int * n, floating * alpha, floating * x, int * incx, 
                     floating * y, int * incy, floating * a, int * lda) nogil:
    if floating is double:
