...
class NegativeSamplingPure(SamplingBase):
    def __init__(self, dataset, data_info, num_neg=1, batch_size=64,
        ...
        super(NegativeSamplingPure, self).__init__(dataset, data_info,
                                                   num_neg, batch_size)
...
class NegativeSamplingFeat(SamplingBase):
    def __init__(self, dataset, data_info, num_neg, batch_size=64):
        super(NegativeSamplingFeat, self).__init__(dataset, data_info,
                                                   num_neg, batch_size)
    ...
    def _shuffle_data(self, dense, sparse_indices_sampled,
                      dense_indices_sampled, dense_values_sampled,
                      label_sampled, seed=42):
...
class PairwiseSampling(SamplingBase):
    def __init__(self, dataset, data_info, num_neg=1, batch_size=64):
        ...
        super(PairwiseSampling, self).__init__(dataset, data_info,
                                               num_neg, batch_size)
